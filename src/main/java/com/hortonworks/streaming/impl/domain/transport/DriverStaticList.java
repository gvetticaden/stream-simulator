...
public class DriverStaticList {
	...
	private static int lastDriverId;
	 ...
	 static {
		...
		DRIVER_LIST.add(new Driver(lastDriverId++, "Jean-Philippe Player", 100));
		...
		DRIVER_LIST.add(new Driver(lastDriverId++, "Sridhara Sabbella", 100));
		...
		DRIVER_LIST.add(new Driver(lastDriverId++, "Dave Patton", 100));
	}
