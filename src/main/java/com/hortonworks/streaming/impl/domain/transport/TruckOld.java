...
//
//public class TruckOld extends AbstractEventEmitter {
//	
//	private static final long serialVersionUID = 9157180698115417087L;
//	private static final Logger LOG = Logger.getLogger(TruckOld.class);
//	
...
//
//	public TruckOld(int numberOfEvents, long demoId, int delayBetweenEvents) {
